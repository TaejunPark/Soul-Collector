...
import nive.soulcollector.Part1.Vision.CameraActivity;
import nive.soulcollector.Part2.GBBActivity;
...
public class NMapViewer extends NMapActivity {
	...
	private static final String API_KEY = "3f25c1410c7dba7c20c1d2229072de09";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//Toast.makeText(this, getApplicationContext().getPackageName().toString(), Toast.LENGTH_SHORT).show();

		if (USE_XML_LAYOUT) {
			setContentView(R.layout.main);
			mMapView = (NMapView)findViewById(R.id.mapView);
			visionBtn = (Button) findViewById(R.id.visionBtn);
			visionBtn.bringToFront();
		} else {
			// create map view
	...
	public void visionStart(View v){
